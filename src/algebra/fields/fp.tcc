...
Fp_model<n,modulus>::Fp_model(const long x, const bool is_unsigned)
{
    ...
    else
    {
        ...
        assert_msg(borrow == 0, "fp.tcc, 206");
    }
...
Fp_model<n,modulus>& Fp_model<n,modulus>::operator+=(const Fp_model<n,modulus>& other)
{
...
#endif
    {
        ...
        if (carry || mpn_cmp(scratch, modulus.data, n) >= 0)
        {
            ...
            assert_msg(borrow == 0, "fp.tcc, 394");
        }
...
Fp_model<n,modulus>& Fp_model<n,modulus>::operator-=(const Fp_model<n,modulus>& other)
{
...
#endif
    {
        ...
        assert_msg(borrow == 0, "fp.tcc, 486");
...
Fp_model<n,modulus>& Fp_model<n,modulus>::invert()
{
    ...
    assert_msg(!this->is_zero(), "fp.tcc, 629");
    ...
    assert_msg(gn == 1 && g.data[0] == 1, "fp.tcc, 640"); /* inverse exists */
    ...
    if (sn < 0)
    {
        ...
        assert_msg(borrow == 0, "fp.tcc, 661");
    }
